! function(e, i) {
    ...
    var s = Array.prototype.slice,
        o = t.console,
        l = void 0 === o ? function() {} : function(t) {
            o.error(t)
        };
...
! function o(a, r, h) {
    function c(s, t) {
        if (!r[s]) {
            ...
            a[s][0].call(n.exports, function(t) {
                var e = a[s][1][t];
                return c(e || t)
            }, n, n.exports, o, a, r, h)
        }
    ...
    2: [function(t, e, s) {
        ...
        e.exports = function(t) {
            var e, s, i, n = 100 < t - this.previousTimeStamp,
    ...
    3: [function(t, e, s) {
        ...
        e.exports = function(i) {
            var n, o, a = this;
            this.activeState !== i && (this.isPaused || (this.isPaused = !0, this.pause()), this.channelsIndex = -1, this.activetransitionSpeed = this.stateTransitionSpeed, this.activeColorDiff = [], this.activeColors = this.getCurrentColors(), this.progress = 0, this.previousTimeStamp = null, this.isChangingState = !0, this.states[i].gradients[0].forEach(function(t, e, s) {
                n = a.hexToRgb(a.states[i].gradients[0][e]), o = a.colorDiff(a.activeColors[e], n), a.activeColorDiff.push(o)
    ...
    7: [function(t, e, s) {
        ...
        e.exports = function() {
            var i, n = [];
            return this.currentColors.forEach(function(t, e, s) {
                for (n.push([]), i = 0; i < 3; i++) n[e].push(t[i])
            }), n
        }
    }, {}],
    8: [function(t, e, s) {
    ...
    9: [function(t, e, s) {
        "use strict";
        e.exports = function() {
            var i, t = this.getCurrentColors(),
                n = [],
                o = null;
            return t.forEach(function(t, e, s) {
                n.push(Math.max(t[0], t[1], t[2]))
            }), n.forEach(function(t, e, s) {
                o = null === o ? t : o + t, e === n.length - 1 && (i = Math.round(o / (e + 1)))
            }), 128 <= i ? "light" : "dark"
        }
    }, {}],
    10: [function(t, e, s) {
    ...
    13: [function(t, e, s) {
        "use strict";
        e.exports = function(t) {
            "isPausedBecauseNotInView" === t || (this.isPaused = !0), cancelAnimationFrame(this.animation)
        }
    }, {}],
    14: [function(t, e, s) {
        "use strict";
        e.exports = function() {
            function t(e) {
                s && clearTimeout(s), s = setTimeout(function() {
                    var t = i.canvas.getBoundingClientRect();
                    t.bottom < 0 || t.right < 0 || t.left > window.innerWidth || t.top > window.innerHeight ? i.isPaused || i.isPausedBecauseNotInView || (i.isPausedBecauseNotInView = !0, i.pause("isPausedBecauseNotInView")) : i.isPaused && !0 !== e || (i.isPausedBecauseNotInView = !1, i.play("isPausedBecauseNotInView"))
                }, 300)
            }
            var s, i = this;
    ...
    15: [function(t, e, s) {
        "use strict";
        e.exports = function(t) {
            "isPausedBecauseNotInView" === t || (this.isPaused = !1), this.animation = requestAnimationFrame(this.animateColors.bind(this))
        }
    }, {}],
    16: [function(t, e, s) {
        "use strict";
        e.exports = function(i) {
            var n, o, a = this;
            this.activeColors.forEach(function(t, e, s) {
                for (o = 0; o < 3; o++)(n = a.activeColors[e][o] + Math.ceil(a.activeColorDiff[e][o] / 100 * i)) <= 255 && 0 <= n && (a.currentColors[e][o] = n)
            }), this.makeGradient()
        }
    }, {}],
    17: [function(t, e, s) {
        ...
        e.exports = function() {
            var o, a, r = this;
            return this.channels[this.activeState] || (this.channels[this.activeState] = []), void 0 !== this.channels[this.activeState][this.channelsIndex] ? (this.activeColors = this.channels[this.activeState][this.channelsIndex].colors, void(this.activeColorDiff = this.channels[this.activeState][this.channelsIndex].colorsDiff)) : (this.channels[this.activeState].push([{}]), this.channels[this.activeState][this.channelsIndex].colors = [], this.channels[this.activeState][this.channelsIndex].colorsDiff = [], this.activeColors = [], this.activeColorDiff = [], this.states[this.activeState].gradients[this.channelsIndex].forEach(function(t, e, s) {
                var i = r.hexToRgb(t),
                    n = r.channels[r.activeState];
                n[r.channelsIndex].colors.push(i), r.activeColors.push(i), r.iscurrentColorsSet || r.currentColors.push(r.hexToRgb(t)), o = r.channelsIndex === r.states[r.activeState].gradients.length - 1 ? r.colorDiff(n[r.channelsIndex].colors[e], n[0].colors[e]) : (a = r.hexToRgb(r.states[r.activeState].gradients[r.channelsIndex + 1][e]), r.colorDiff(n[r.channelsIndex].colors[e], a)), n[r.channelsIndex].colorsDiff.push(o), r.activeColorDiff.push(o)
